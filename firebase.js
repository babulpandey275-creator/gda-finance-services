...
import { getAuth } from "https://www.gstatic.com/firebasejs/12.0.0/firebase-auth.js"; // 1. लॉगिन मॉड्यूल जोड़ा
...
const auth = getAuth(app); // 2. लॉगिन सिस्टम एक्टिवेट किया
...
// 3. यहाँ auth को भी एक्सपोर्ट किया ताकि दूसरी फाइलें इस्तेमाल कर सकें
export { db, auth };
