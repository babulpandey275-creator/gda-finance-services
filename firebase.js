// Firebase SDK Modules - Version 12.0.0
...
// Firebase Configuration (GDA Finance Services)
...
// Enable Offline Persistence (ऑफलाइन काम करने की क्षमता)
...
// एक्सपोर्ट ताकि दूसरी फाइलें इस्तेमाल कर सकें
export { db, auth };
