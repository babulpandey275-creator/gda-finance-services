...
window.addEventListener('DOMContentLoaded', async () => {
    ...
    // URL से ग्राहक की ID निकालना (जिस कस्टमर पर क्लिक किया गया है)
    ...
    async function loadCustomersDropdown() {
        try {
            ...
            // 🔥 [फिक्स]: अगर लिस्ट से ID आई है, तो उसे तुरंत यहाँ सिलेक्ट करके उसका पूरा डेटा दिखाओ
    ...
    // ड्रापडाउन हाथ से चेंज होने पर डेटा बदलना
    if (customerSelect) {
    ...
    if (submitCollectionBtn) {
        submitCollectionBtn.onclick = async (e) => {
            ...
            try {
                ...
                // A. कलेक्शन टेबल में नई एंट्री जोड़ना
